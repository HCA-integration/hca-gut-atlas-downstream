...
|---|---|---|
| [MetaManager](https://github.com/CellDiscoveryNetwork/MetaManager) | Metadata ingestion and Supplementary Figure 2 validation | 
| [ARBOL](https://github.com/jo-m-lab/ARBOL) | Figure 2b taxonomy trees | 
| [patpy](https://github.com/lueckenlab/patpy) | Sample embeddings and pretreatment remission AUC (S16a,c) | 
| [scAtlasTb](https://github.com/HCA-integration/scAtlasTb) | 
| [ArchMap](https://www.archmap.bio/) | Query-to-reference mapping onto the four lineage scANVI models (Fig. 4b-style) | 
