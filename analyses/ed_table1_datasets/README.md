...
Script: `src/build_extended_data_table1.py`

Output: `ExtendedDataTable1_HGCA_v1_datasets.csv` / `.xlsx` and a column
dictionary. Requires `openpyxl`.

```bash
python analyses/ed_table1_datasets/src/build_extended_data_table1.py \
