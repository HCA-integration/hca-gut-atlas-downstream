...
The output CSVs feed src/ccc_centrality_gut_axis.R and
src/ccc_ensemble_synthesis.R. Paper run: LIANA_METHOD=rank_aggregate,
n_perms=1000, expr_prop=0.1, MAX_CELLS=12000, consensus resource.
...
Env:
  LIANA_AD_PATH        AnnData .h5ad path (or HGCA_H5AD)
  LIANA_OUTPUT_DIR     output dir (default analyses/sfig13_liana/out)
...
AD_PATH = env_str("LIANA_AD_PATH", env_str("HGCA_H5AD", ""))
if not AD_PATH:
    sys.exit("Set LIANA_AD_PATH or HGCA_H5AD to the all-cells h5ad.")
OUT_DIR = Path(
    env_str(
        "LIANA_OUTPUT_DIR",
