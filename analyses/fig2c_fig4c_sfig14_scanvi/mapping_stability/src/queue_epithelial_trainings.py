#!/usr/bin/env python3
"""Queue epithelial screening trainings. Skips complete checkpoints."""
...
SHARED = ROOT.parent / "manifests" / "epithelial_shared_studies_exact_name.csv"
...
def complete(atlas: str, omit: str, seed: int) -> bool:
    ...
    d = MODELS / atlas / "epithelial" / omit_tag / f"seed{seed}"
